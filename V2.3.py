...
def ada_boost_train_ds_with_flipping(data_arr, class_labels, num_it=100):
    ...
    '''会让决策边界的移动更加激进，如果是重叠程度大的数据集，可以调高一点'''
    ...
    print("--- Starting AdaBoost Training with Boundary Flipping and Outlier Suppression ---")
